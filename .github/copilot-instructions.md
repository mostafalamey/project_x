...
- Browser-based IndexedDB via Dexie.js for autosave; LocalStorage for preferences; Export to downloadable JSON/ZIP files (004-admin-config-dashboard)
...
## Recent Changes
- 004-admin-config-dashboard: Added TypeScript 5.3.3 with React 18.3.1
